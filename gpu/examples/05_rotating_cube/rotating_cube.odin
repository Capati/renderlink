...
init :: proc(self: ^Application) -> (ok: bool) {
    ...
    vertex_source :=
        common.load_shader_source(self.device, "05_rotating_cube", .Vertex, ta) or_return
    ...
    fragment_source :=
        common.load_shader_source(self.device, "05_rotating_cube", .Fragment, ta) or_return
