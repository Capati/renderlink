...
mouse_button_get_pressed :: #force_inline proc "contextless" (app: ^Application) -> Mouse_Button {
    return app.mouse.last_button_pressed
}

/* Returns the current position of the mouse cursor. */
mouse_get_position :: #force_inline proc "contextless" (app: ^Application) -> [2]f64 {
    return app.mouse.position
}

/* Returns the previous position of the mouse cursor. */
mouse_get_previous_position :: #force_inline proc "contextless" (app: ^Application) -> [2]f64 {
...
*/
mouse_get_scroll :: #force_inline proc "contextless" (app: ^Application) -> [2]f64 {
